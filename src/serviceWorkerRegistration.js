...
// serviceWorkerRegistration.unregister() to unregister it.
          ...
          installingWorker.onstatechange = () => {
            if (installingWorker.state === 'installed') {
              if (navigator.serviceWorker.controller) {
                ...
                // At this point, everything has been fetched, but nothing has been
                // activated, so it's a "fresh install" of an app.
